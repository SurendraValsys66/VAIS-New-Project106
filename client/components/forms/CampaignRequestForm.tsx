            ...
            <TabsContent value="assets" className="mt-4">
              <div className="bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm">
                <div className="bg-gradient-to-r from-purple-50 to-pink-100 px-6 py-4 border-b border-gray-200">
                  ...
                  <p className="text-xs text-gray-600 mt-1">
                    AI-generated and custom assets configured for this campaign
                  </p>
                </div>
                {selectedAssets && selectedAssets.length > 0 ? (
                      ...
                      >
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            {asset.config &&
                              Object.keys(asset.config).length > 0 && (
                                <div className="bg-blue-50 rounded p-2 mt-2 text-xs text-blue-700">
                                  <p className="font-medium mb-1">
                                    Configuration:
                                  </p>
                                  <ul className="space-y-0.5">
                                    {Object.entries(asset.config).map(
                                      ([key, value]) =>
                                        value && (
                                          <li key={key}>
                                            • {key}: {String(value)}
                  ...
                  <div className="px-6 py-8 text-center">
                    ...
                    <p className="text-xs text-gray-500">
                      You can add assets during campaign creation to enhance your
                      outreach with AI-generated emails and landing pages.
                    </p>
                  </div>
                )}
              </div>
